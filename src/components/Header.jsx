        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {user ? (
            <div className="flex items-center gap-3">
              <Link to="/account" className="flex items-center gap-2 text-text hover:text-primary transition">
                {avatarUrl ? (
          ...
          <div className="container mx-auto px-4 flex flex-col space-y-3">
            ...
            {user ? (
              <div className="pt-2 space-y-2">
                <Link to="/account" className="flex items-center gap-3 py-2" onClick={closeMenu}>
                  {avatarUrl ? (
