...
export default function AuthModal({ isOpen, onClose }) {
  ...
  if (isMobile) {
    return (
      <BottomSheet open={isOpen} onClose={onClose} title={mode === "login" ? t("auth.login") : mode === "reset" ? (resetSent ? "Check Your Email" : "Reset Password") : t("auth.signup")}>
        {formContent}
      </BottomSheet>
    );
  }
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        tabIndex={-1}
        className="relative bg-white dark:bg-neutral-dark rounded-2xl shadow-2xl w-full max-w-md p-6 mx-4 outline-none max-h-[90vh] overflow-y-auto overscroll-contain"
