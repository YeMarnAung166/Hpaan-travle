    ...
    <div className="container-custom">
      ...
      {allEvents.length === 0 && (
        <div className="text-center py-16">
          ...
          <p className="text-text-soft text-lg mb-4">{t('events.no_events') || 'No events found. Check back later!'}</p>
          <Link to="/destinations" className="inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-full text-sm font-medium hover:bg-primary-light transition-colors shadow-md">
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
            {t('events.explore_destinations') || 'Explore Destinations'}
          </Link>
        </div>
      )}
