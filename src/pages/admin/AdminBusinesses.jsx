    ...
    <>
      ...
      >
        ...
        <div className="border-b pb-3 mb-3">
          ...
          <input type="text" name="name" placeholder="Business Name (English)" value={formData.name} onChange={handleInputChange} className="w-full border rounded px-3 py-2 mb-2" required />
          <select name="category" value={formData.category} onChange={handleInputChange} className="w-full border rounded px-3 py-2 mb-2">
          ...
          <input type="text" name="address" placeholder="Address (English)" value={formData.address} onChange={handleInputChange} className="w-full border rounded px-3 py-2 mb-2" />
        </div>
        {/* Burmese Fields */}
        <div className="border-b pb-3 mb-3">
          <h3 className="font-semibold mb-2">မြန်မာ (Burmese)</h3>
          <input type="text" name="name_my" placeholder="အမည် (မြန်မာ)" value={formData.name_my} onChange={handleInputChange} className="w-full border rounded px-3 py-2 mb-2" />
          ...
          <input type="text" name="address_my" placeholder="လိပ်စာ (မြန်မာ)" value={formData.address_my} onChange={handleInputChange} className="w-full border rounded px-3 py-2 mb-2" />
        </div>
        {/* Media & Contact */}
        <div>
          <h3 className="font-semibold mb-2">Contact & Media</h3>
          <input type="tel" name="phone" placeholder="Phone Number" value={formData.phone} onChange={handleInputChange} className="w-full border rounded px-3 py-2 mb-2" />
          <ImageUploader
